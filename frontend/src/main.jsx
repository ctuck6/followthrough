...
function NavIcon({index}) {
 const shapes=[<><rect x="4" y="3" width="16" height="18" rx="3"/><path d="m8 12 2 2 5-5M8 18h8"/></>,<><rect x="3" y="5" width="18" height="16" rx="3"/><path d="M7 3v4m10-4v4M3 10h18M8 14h1m6 0h1m-8 4h1m6 0h1"/></>,<><path d="M5 4h14v17l-7-3-7 3zM9 8h6m-6 4h6"/></>,<><circle cx="12" cy="8" r="4"/><path d="M4 21v-2a8 8 0 0 1 16 0v2"/></>];
...
function App(){
 ...
 {tab==='Calendar'&&<Calendar days={data.days} summaries={ledger.summaries} today={today} onOpen={selectDate}/>}
